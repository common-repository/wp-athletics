...
include_once 'includes/wp-athletics-leagues.php';
...
if(!class_exists('WP_Athletics')) {
	...
	class WP_Athletics {
		...
		public function __construct() {
			...
			add_shortcode( 'wpa-league', array( $this, 'do_league' ) );
			...
			//add_shortcode( 'wpa-simple-league', array( $this, 'do_simple_league' ) );
		...
		/**
		 * Shortcode action for a league table page
		 */
		public function do_league( $atts ) {
			$this->leagues = new WP_Athletics_Leagues( $this->wpa_db );
			$this->leagues->league_table( $atts );
		}
