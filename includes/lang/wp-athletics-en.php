...
$common_lang = array(
	...
	// leagues
	'leagues_table_of_results_help' => 'Displaying all results this athlete has participated in for this league. The highlighted rows are the events that count towards the athletes total score',
	'league_tab_table' => 'League Table',
	'league_tab_events' => 'League Events',
	'league_status_complete' => 'Completed',
	'league_status_future' => 'Pending',
	'league_complete_message' => 'All league events have been completed. Displaying the final standings',
	'league_rank_by_age_grade' => 'League scores are calculated by the athletes combined age grade % for each event',
	'league_rank_by_time' => 'League scores are calculated by the athletes combined time for each event',
	'league_rank_by_age_position' => 'League scores are calculated by the athletes combined finishing position for each event',
	'league_rule_all' => 'Athletes must participate in all events to appear on the league table',
	'league_rule_partial' => 'Athletes must paricipate in at least <number> of events to appear on the league table',
	'league_rule_gender' => 'Participation is restricted to <gender> athletes only',
	...
	'stats_label_event_best' => 'Fastest Result',
	'stats_label_event_worst' => 'Slowest Result',
...
$admin_lang = array(
	...
	'admin_settings_recalculate_age_grades' => 'Recalculate all age grades',
	...
	// leagues
	'leagues_default_option' => 'Select a league to manage...',	
	'leagues_empty_option' => 'No Leagues, create a new one >>>',
	'admin_leagues_title' => 'Manage Leagues',
	'leagues_create_button' => 'Create a new League',
	'leagues_generate_page_button' => 'Generate League Page',
	'leagues_view_page_button' => 'View League Page',
	'leagues_create_title' => 'Create League',
	'leagues_edit_events_title' => 'Add/Remove League Events',
	'leagues_edit_title' => 'Manage League',
	'leagues_form_name' => 'League Name',
	'leagues_form_details' => 'Details',
	'leagues_form_rank_by' => 'Rank By',
	'leagues_form_gender' => 'Gender',
	'leagues_form_age_cat' => 'Age Category',
	'leagues_rank_by_age_grade' => 'Age Grade',
	'leagues_rank_by_time' => 'Total Time',
	'leagues_rank_by_position' => 'Position',
	'league_participation' => 'Participation Rule',
	'league_participation_all' => 'Athletes must attend all league events',
	'league_participation_partial' => 'Athletes must attend at least...',
	'league_participation_events' => 'event(s)',
	'league_participation_partial_help' => 'Only the best [number] of results will be counted in the league table',
	'leagues_select_all' => 'All',
	'leagues_save_button' => 'Save',
	'leagues_delete_button' => 'Delete League',
	'leagues_rules_title' => 'League Rules',
	'leagues_error_event_already_added' => 'This event has already been added to the league',
	'delete_league_text' => 'Are you sure you wish to delete this league? This cannot be undone',
	'delete_league_title' => 'Delete League',
	'leagues_add_existing_event' => 'Add an existing event to your league',
	'leagues_create_new_event' => 'Or create a new event',
	'leagues_error_invalid_participation_rule_no_events' => 'Invaid participation rule. First add some events and then select the minimum number of events an athlete must participate in'
);
