	...
	<script type="text/javascript">
		jQuery(document).ready(function() {
			...
			WPA.Ajax.setup('<?php echo admin_url( 'admin-ajax.php' ); ?>', '<?php echo $nonce; ?>', '<?php echo WPA_PLUGIN_URL; ?>', '<?php echo $current_user->ID; ?>',  function() {
				...
				jQuery('#wpa-admin-age-grade-button').button().click(function() {
					if(confirm('This could take a while depending on how many results are in your system. Ready to go?')) {
						WPA.Admin.ageGradeConsole = jQuery('#age-grade-console');
						WPA.Admin.recalculateAgeGrades();
					}
				});
		...
		<div id="wpa-admin-settings-container">
			<div id="wpa-admin-settings-tab">
				...
				<div id="wpa-admin-settings-advanced">
					...
					<div class="wpa-admin-setting">
						<label><?php echo $this->get_property('admin_settings_recalculate_age_grades') ?>:</label>
						<button id="wpa-admin-age-grade-button"><?= $this->get_property('go') ?></button><span id="age-grade-console"></span>
					</div>
				</div>
			</div>
